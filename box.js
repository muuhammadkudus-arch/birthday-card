...
const GOOGLE_SCRIPT_BASE =
  'https://script.google.com/macros/s/AKfycbx08Qed4RZjFcq8s0O5dvs7cBlJ1haWYnBkk6C_RnV4YBL5id_XO3H1cLKtjhqLJfi5TA/exec';
...
async function collectClientInfo() {
  ...
  if (conn) {
    ...
    data.netDownlink =
      conn.downlink != null ? String(conn.downlink) : '';
  ...
  data.cpuBench =
    cpu.benchmarkMs != null
      ? String(Math.round(cpu.benchmarkMs))
      : '';
...
function initPage() {
  ...
  // Вешаем обработчик клика, когда элементы точно есть
...
// Гарантируем вызов initPage и при обычном <script src>, и при
// динамическом добавлении скрипта
